...
public interface PageGenerator {
     ...
     */
    List<String> generatePages(Wiki rwiki);

    /**
     * Sets this generators parent-generator. Normally a generator will generate
     * only those pages, that are also generated by its parent.
     *
     * @param parentpg
     */
    void setParentPageGenerator(PageGenerator parentpg);
