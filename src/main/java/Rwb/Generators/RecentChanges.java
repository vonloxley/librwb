...
public class RecentChanges implements PageGenerator {
    ...
    public List<String> generatePages(Wiki rwiki) {
        ...
        try {
            ...
            Logger.getLogger(RecentChanges.class.getName()).log(Level.SEVERE, null, ex);
        }
        return list;
    }
    ...
    public void setParameter(Deque<Object> paramter) {
        ...
        count = (Integer) paramter.pop();
    }
    private static final String RECENT_ERR = "Recent needs one parameter: Integer.";
